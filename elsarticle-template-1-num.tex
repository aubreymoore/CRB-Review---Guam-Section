...
First observation of CRB on Guam was an adult female retrieved from an ornamental pond in Tumon Bay (lat, lon) by a member of the public on September 11, 2007. A delimiting survey found multiple larval breeding sites and damage to coconut palms in the form of v-shaped cuts in a relatively small area (xxx ha) in Tumon Bay and Fafai Bay.

\subsection{Eradication Attempt}

Spread to green waste dump sites. \cite{moore_movement_2016}
